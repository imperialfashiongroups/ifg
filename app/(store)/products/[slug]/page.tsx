...
async function getProduct(slug: string) {
  const SAMPLE_PRODUCTS: Record<string, any> = {
    'embroidered-lehenga-choli': {
      ...
      description: 'A stunning hand-embroidered lehenga choli perfect for weddings, festivals, and special occasions. Crafted from premium georgette fabric with intricate zari work and mirror embellishments. This exquisite ensemble features a flared lehenga, a fitted blouse with back zip closure, and a matching dupatta with tassel detailing.',
      mrp: 3999,
      discount_pct: 25,
      gst_rate: 12,
      is_new_arrival: true,
      ...
      variants: [
        ...
        { id: 'v4', size: 'XL',  color: 'Red',  color_hex: '#dc2626', stock_qty: 2 },
        { id: 'v5', size: 'S',   color: 'Blue', color_hex: '#2563eb', stock_qty: 4 },
        { id: 'v6', size: 'M',   color: 'Blue', color_hex: '#2563eb', stock_qty: 6 },
        { id: 'v7', size: 'L',   color: 'Blue', color_hex: '#2563eb', stock_qty: 0 },
      ],
      images: [
        { id: 'i1', url: '/placeholder/lehenga-1.jpg', is_primary: true,  alt_text: 'Embroidered Lehenga Choli Front' },
        { id: 'i2', url: '/placeholder/lehenga-2.jpg', is_primary: false, alt_text: 'Embroidered Lehenga Choli Back' },
        { id: 'i3', url: '/placeholder/lehenga-3.jpg', is_primary: false, alt_text: 'Embroidered Lehenga Choli Detail' },
      ],
      reviews: [
        ...
        { id: 'r2', rating: 4, title: 'Great Quality',         body: 'Loved the color and fit. Delivery was quick too!',              profile: { full_name: 'Anita K.' }, created_at: '2025-06-10' },
      ],
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const price = product.mrp * (1 - product.discount_pct / 100);
  return {
    title: product.name,
...
export default async function ProductDetailPage({ params }: PageProps) {
  ...
  const avgRating = product.reviews.reduce((s: number, r: any) => s + r.rating, 0) / product.reviews.length;
      ...
      <div className="section py-8 md:py-12">
        <div className="grid lg:grid-cols-2 gap-10 xl:gap-16">
            ...
            <div className="relative aspect-[4/5] bg-gray-100 rounded-2xl overflow-hidden">
              <div className="absolute inset-0 flex items-center justify-center text-gray-400">
                <div className="text-center flex flex-col items-center">
                  <Sparkles className="w-20 h-20 text-gold-400/80 mb-4 animate-pulse-gold" />
          ...
          <div>
            ...
            {/* Size Chart */}
            <div className="mt-3">
              <SizeChart category={product.category.name} />
            </div>
